...
| Lesson 2 (w1:d2)    | [Unit Lab 1: Variables](xxx), [Conditionals](xxx), [Lists](xxx)                                                                                                                                    |   | [Homework: Using `if` and `else`](unit-2-control-flow/instructor-resources/hw-10wk-class-2)                                                                                           |
