...
| Lesson 5 (w3:d1)    | [Dictionaries, Sets and Tuples: slides](https://docs.google.com/presentation/d/1QrukUJk-RoL6rNeNzx1ApzvtqZC501-u5LkGjRHNsfs/edit?usp=sharing), [In-class notebook](https://drive.google.com/file/d/1lczLbB-9b7ZoYDVB-MmRxu9J5WVmkj79/view?usp=sharing)  | [Functions: in-class review](https://colab.research.google.com/drive/1DY69ECm7-c8idt_WtffUj0Pd7MOAT4GV?usp=sharing), [Day 5 Recording](xx)  | [Homework: Dictionaries](https://drive.google.com/file/d/1lczLbB-9b7ZoYDVB-MmRxu9J5WVmkj79/view?usp=sharing) |
| Lesson 6 (w3:d2)    | [Classes](x), [Inheritance](x), [Unit Lab 3: Object Oriented Programming](x)   |   | [Homework: Functions, dictionaries, inheritance, kwargs](x) AND one myGA Lesson: Error Handling in Python |
| Lesson 7 (w4:d1)    | [Variable Scope](x), [Intermediate Variables](x), [Debugging Principles and Techniques](x) |   | [Homework: Type Conversion, String Formatting, Debugging, Scope](x)  |
| Lesson 8 (w4:d2)    | [Unit Lab 4: Troubleshooting](xx), [Introduction to Intermediate Python](xx), [Scripting](xxx) |   | [Homework: Scripting, File I/O, and Lists](unit-5-intermediate/instructor-resources/hw-10wk-class-8)  |
| Lesson 9 (w5:d1)    | [Modules and Libraries](xxx) |   | [Homework: Modules and Libraries](xxx)  |
| Lesson 10 (w5:d2)   | [APIs](xxx), Review |   | [Homework: APIs and String Formatting](xxx) |
| Lesson 11 (w6:d1)   | [Unit Lab 5: Intermediate Python](xxx) |   | [Homework: APIs, Debugging, Scripting](xxx) |
| Lesson 12d (w6:d2)  | *Data Track*: [Introduction to Data Science](xxx), [Pandas I](uxxx)  |   | [Homework: Reading datasets into Pandas,  Filtering, manipulating, and sorting datasets, Basic exploratory data analysis with Pandas](xxxd) |
| Lesson 13d (w7:d1)  | *Data Track*: [Data Visualization](xxx), [Plotting with Pandas and Matplotlib](xxxx)  |   | [Homework: Plotting with Pandas, Determining the best plot, given a dataset](xxx)  |
| Lesson 14d (w7:d2)  | *Data Track*: [Pandas II](xxx), [Unit Lab 6: Pandas](xxx)  |   | [Homework: Basic EDA with Pandas, Visualization with Pandas](xxx)  |
| Lesson 15d (w8:d1)  | *Data Track*: Lab Review, [Next Steps with Data Science](xxx)|   | < None > |
| Lesson 16d (w8:d2)  | *Data Track*: [Overall Review and Q&A](xxx), [Introduce Project](xxx)|   | < None >|
